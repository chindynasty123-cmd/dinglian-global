const translations = {
  zh: {
    ...
    "brand.position": "台灣品質標準<br>全球製造整合",
    "hero.title": "一張圖面，<br>多元製造解決方案",
    "hero.subtitle":
      "<span>透過台灣品質管理標準，<br>整合亞洲值得信賴的製造資源。</span><span>協助全球客戶降低採購成本、<br>提升供應鏈彈性，<br>並透過單一窗口完成專案管理。</span>",
  ...
  en: {
    ...
    "brand.position": "TAIWAN QUALITY STANDARD<br>GLOBAL MANUFACTURING INTEGRATION",
    "hero.title": "One Drawing.<br>Multiple Manufacturing Solutions.",
    "hero.subtitle":
      "<span>A Taiwan-managed manufacturing network connecting trusted suppliers across Asia.</span><span>Helping global customers reduce cost, improve supply chain flexibility and simplify sourcing through one contact window.</span>",
    ...
    "hero.node.southAmerica": "South America",
    "story.title":
