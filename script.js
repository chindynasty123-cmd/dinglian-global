const translations = {
  zh: {
    ...
    "quality.title": "品質不是檢驗出來的，<br>而是製造出來的。",
    "quality.copy": "以可追溯管理、精密量測與完整文件，支援國際級專案需求。",
    "base.label": "瑨達基地",
    "base.name": "瑨達工業",
    "base.subtitle": "20年以上精密製造經驗",
    "base.statement": "二十年的製造底蘊，<br>成就鼎鏈邁向全球的基石。",
    "base.button": "前往瑨達基地 →",
    "base.panel": "鼎鏈背後的製造基礎",
    "base.panelKicker": "製造基礎",
    "base.since": "創立於 2005",
    "base.exp": "20年以上製造經驗",
    "base.cmm": "三次元量測",
    "base.keyence": "KEYENCE 影像量測",
    "base.support": "24小時生產支援",
  ...
  en: {
    ...
    "quality.title": "Quality Is Built Into Every Process",
    "quality.copy":
      "Every program is managed with traceability, measurement discipline and documentation for international customers.",
    "base.label": "JINTAT FOUNDATION",
    "base.name": "Jintat Industrial",
    ...
    "base.panel": "The Manufacturing Foundation Behind Dinglian",
    "base.panelKicker": "MANUFACTURING FOUNDATION",
    "base.since": "Since 2005",
    "base.exp": "20+ Years Manufacturing Experience",
    "base.cmm": "CMM Inspection",
    "base.keyence": "KEYENCE Measurement",
    "base.support": "24/7 Production Support",
...
const localizedData = {
  ...
  en: {
    ...
    base: [
      ...
      "KEYENCE Vision Measurement System",
    ],
  },
};
