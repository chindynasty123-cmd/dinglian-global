const translations = {
  zh: {
    ...
    "brand.position": "全球製造整合夥伴",
    "hero.title": "一張圖面，<br>多元製造解決方案。",
    "hero.subtitle":
      "整合亞洲值得信賴的製造資源，<br>並交付至全球市場。<br>從樣品開發到量產交付，<br>讓製造專案更簡單。",
  ...
  en: {
    ...
    "brand.position": "GLOBAL MANUFACTURING INTEGRATION PARTNER",
    "hero.title": "One Drawing.<br>Multiple Manufacturing Solutions.",
    "hero.subtitle":
      "Connecting trusted manufacturing resources in Asia<br>and delivering to the world.<br>From prototype to production, we make it simple.",
