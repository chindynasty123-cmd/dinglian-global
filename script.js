const translations = {
  zh: {
    ...
    "brand.position": "全球製造夥伴",
    "hero.title": "全球製造整合",
    "hero.subtitle": "串聯全球需求與值得信賴的製造資源。",
    "hero.quote": "取得報價",
    "hero.explore": "探索產業",
    ...
    "base.label": "核心製造基地",
    "base.name": "瑨達工業<br>Jintat Industrial Co., Ltd.",
    "base.subtitle": "鼎鏈科技核心製造夥伴",
    "base.statement": "20年以上精密加工經驗，<br>支援樣品開發、小量生產與量產交付。<br><br>提供穩定品質管理、<br>精密量測與生產支援能力。",
    "base.button": "了解瑨達工業 →",
    "base.panel": "鼎鏈科技核心製造夥伴",
  ...
  en: {
    ...
    "brand.position": "GLOBAL MANUFACTURING PARTNER",
    "hero.title": "Global Manufacturing Integration",
    "hero.subtitle":
      "Connecting global demand with trusted manufacturing resources.",
    ...
    "base.panel":
      "Core Manufacturing Partner of Dinglian Technology",
    "base.panelKicker": "Core Manufacturing Base",
    "base.since": "20+ Years Experience",
    "base.est": "Manufacturing Support",
    "base.country": "Taiwan",
    "base.panelTitle": "Jintat Industrial",
    "base.iso": "ISO 9001",
    "base.cmm": "Mitutoyo CMM",
    "base.keyence": "KEYENCE Inspection",
    "base.support": "24/7 Production",
...
const localizedData = {
  zh: {
    ...
    solutions: [
      "Requirement Review<br><small>需求評估</small>",
      "Supplier Matching<br><small>供應鏈匹配</small>",
      "Manufacturing Planning<br><small>製程規劃</small>",
      "Production Management<br><small>生產管理</small>",
      "Quality Assurance<br><small>品質驗證</small>",
      "Surface Treatment Integration<br><small>表面處理整合</small>",
      "Assembly Support<br><small>組裝服務</small>",
      "Documentation & Reports<br><small>文件與報告</small>",
      "Project Delivery<br><small>專案交付</small>",
    ],
    quality: [
      "ISO 9001",
      "三次元量測",
