const translations = {
  zh: {
    ...
    "brand.position": "台灣品質管理｜亞洲供應鏈整合｜全球交付",
    "hero.title": "台灣品質管理<br>整合亞洲供應鏈<br>全球穩定交付",
    "hero.subtitle":
      "以台灣品質管理為核心，<br>整合亞洲優質製造資源，<br>在非紅供應鏈要求下，<br>協助客戶降低成本、分散風險，<br>並透過單一窗口完成全球交付。",
    "hero.supporting": "一張圖面，<br>多元製造方案。",
    "hero.quote": "立即詢價",
    "hero.explore": "了解解決方案",
    "hero.node.taiwan": "台灣<br>品質樞紐",
    "hero.node.vietnam": "越南",
    "hero.node.thailand": "泰國",
    "hero.node.malaysia": "馬來西亞",
    "hero.node.singapore": "新加坡",
    "hero.node.indonesia": "印尼",
    "hero.node.japan": "日本",
    "hero.node.korea": "南韓",
    "hero.node.europe": "歐洲",
    "hero.node.northAmerica": "北美",
    "hero.feature.quality": "台灣品質標準",
    "hero.feature.asia": "亞洲供應鏈整合",
    "hero.feature.cost": "成本最佳化",
    "hero.feature.nonRed": "非紅供應鏈",
    "hero.feature.window": "單一窗口服務",
    "hero.feature.delivery": "全球交付能力",
    "story.title": "二十年的製造底蘊，<br>成就全新的全球視野",
    "story.subtitle":
      "從精密加工起步，<br>一路累積跨產業製造經驗，<br>最終成立鼎鏈科技，<br>成為串聯全球需求與台灣製造資源的整合平台。",
    "story.card1": "以台灣精密製造為根基，累積穩定量產與品質管理能力。",
    "story.card1Title": "瑨達工業",
    "story.centerLabel": "製造演進",
    "story.card3":
      "整合需求、供應鏈資源與品質交付，成為面向全球客戶的製造整合平台。",
    ...
    "footer.brand": "鼎鏈科技",
    "footer.message": "全球製造整合平台",
    "footer.industries": "半導體 · 航太 · 機器人 · 工業自動化 · 醫療",
    "footer.copyright": "© 2026 鼎鏈科技",
    "form.name": "姓名",
    "form.company": "公司",
    "form.email": "電子郵件",
    "form.phone": "電話",
    ...
    "form.quantity": "數量",
    "form.message": "需求說明",
    "form.upload": "上傳檔案（PDF、STEP、DWG、ZIP）",
  ...
  en: {
    ...
    "brand.position": "Taiwan Quality Management | Asia Supply Chain Integration | Global Delivery",
    "hero.title": "Taiwan Quality.<br>Asia Supply Chain.<br>Global Delivery.",
    "hero.subtitle":
      "Leveraging Taiwan quality standards,<br>we integrate Asia's manufacturing resources<br>to reduce cost, diversify risk,<br>and ensure reliable global delivery.",
    "hero.supporting": "One Drawing.<br>Multiple Manufacturing Solutions.",
    "hero.quote": "GET A QUOTE",
    "hero.explore": "EXPLORE SOLUTIONS",
    "hero.node.taiwan": "TAIWAN<br>Quality Hub",
    "hero.node.vietnam": "Vietnam",
    "hero.node.thailand": "Thailand",
    "hero.node.malaysia": "Malaysia",
    "hero.node.singapore": "Singapore",
    "hero.node.indonesia": "Indonesia",
    "hero.node.japan": "Japan",
    "hero.node.korea": "South Korea",
    "hero.node.europe": "Europe",
    "hero.node.northAmerica": "North America",
    "hero.feature.quality": "Taiwan Quality Standard",
    "hero.feature.asia": "Asia Supply Chain Integration",
    "hero.feature.cost": "Cost Optimization",
    "hero.feature.nonRed": "Non-Red Supply Chain",
    "hero.feature.window": "One Contact Window",
    "hero.feature.delivery": "Global Delivery",
    "story.title":
      "20 Years of Manufacturing Foundation,<br>A New Global Vision",
    "story.subtitle":
      "Starting from precision machining, Dinglian accumulated cross-industry manufacturing experience and became an integration platform connecting global demand with Taiwan manufacturing resources.",
    "story.card1":
      "A Taiwan precision manufacturing foundation built for stable production and disciplined quality management.",
    "story.card1Title": "Jintat Industrial",
    "story.centerLabel": "Manufacturing Evolution",
    "story.card3":
    ...
    "footer.message": "Global Manufacturing Integration Platform",
    "footer.industries":
      "Semiconductor · Aerospace · Robotics · Industrial Automation · Medical",
    "footer.copyright": "© 2026 DINGLIAN TECHNOLOGY",
    "form.name": "Name",
    ...
    "form.upload": "Upload File (PDF, STEP, DWG, ZIP)",
    "form.thanks": "Thank you. Dinglian Technology will contact you soon.",
  },
};
const localizedData = {
  zh: {
  ...
  en: {
    ...
    trust: [
      ...
      ["CMM + KEYENCE", "Inspection Capability"],
...
function render(lang) {
  ...
  qualityList.innerHTML = data.quality
    ...
    .join("");
  baseList.innerHTML = data.base.map((b) => `<span>${b}</span>`).join("");
}
...
function setLang(lang) {
  ...
  document
    ...
    .forEach(
      (el) =>
        (el.innerHTML =
          translations[lang][el.dataset.i18nHtml] || el.innerHTML),
    );
  document
  ...
  localStorage.setItem("dinglianLang", lang);
  observeReveals();
}
setLang(localStorage.getItem("dinglianLang") || "zh");
document
  .querySelectorAll(".lang")
...
document.querySelector(".quote-form").addEventListener("submit", (e) => {
  e.preventDefault();
  alert(
    translations[localStorage.getItem("dinglianLang") || "zh"]["form.thanks"],
  );
});
