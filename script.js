const translations = {
  zh: {
    ...
    "brand.position": "台灣品質標準｜全球製造整合",
    "hero.title": "全球製造整合方案",
    "hero.subtitle":
      "<span>以台灣品質標準整合亞洲製造資源，<br>協助客戶降低成本、分散供應鏈風險，<br>並維持穩定品質與交期。</span><strong>一張圖面，<br>多元製造方案。</strong>",
    "hero.quote": "立即詢價",
    "hero.explore": "了解產業應用",
    "hero.node.taiwan": "台灣",
  ...
  en: {
    ...
    "brand.position": "Taiwan Quality Standard | Global Manufacturing Integration",
    "hero.title": "Global Manufacturing Integration",
    "hero.subtitle":
      "<span>Connecting trusted manufacturing resources across Asia<br>with Taiwan quality standards and global delivery capability.</span><strong>One Drawing.<br>Multiple Manufacturing Solutions.</strong>",
